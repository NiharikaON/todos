      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:flex-none lg:w-1/2 lg:px-20 xl:px-24 relative bg-gray-50 dark:bg-gray-900">
        ...
        <div className="mx-auto w-full max-w-sm lg:max-w-md relative z-10">
          ...
          <div className="mt-8">
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link href="/forgot-password" className="text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 transition-colors">
                    Forgot password?
                  </Link>
                </div>
                <input
            ...
            {/* Social Logins - Disabled/Hidden for now as requested by user */}
